...
2. Search and queue perfumes. The search covers 71,772 of them. Three settings to decide: whether players see real names or just "Perfume #1", whether you're playing too, and how scoring works (below).
